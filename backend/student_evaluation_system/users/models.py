...
class StudentProfile(models.Model):
    ...
    enrollment_term = models.ForeignKey(
        "core.Term", on_delete=models.SET_NULL, null=True, blank=True, related_name="enrolled_students", db_index=True
    )
    program = models.ForeignKey(
        "core.Program", on_delete=models.SET_NULL, null=True, blank=True, related_name="students", db_index=True
    )

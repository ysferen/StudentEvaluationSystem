...
class DeprecationMixin:
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if self.deprecation_message:
            ...
            warnings.warn(f"API Deprecation: {self.deprecation_message}", DeprecationWarning, stacklevel=2)
...
class VersionedSerializerViewMixin:
    ...
    def get_serializer_class(self):
        ...
        return get_versioned_serializer(self.request.version, self.v1_serializer_class, self.v2_serializer_class)
